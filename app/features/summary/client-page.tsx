  ...
  return (
    <>
      ...
      <div className="summary-overview">
        ...
        <ChainMap w={w} />
        <p className="client-retention" aria-live="polite">
          保留原文 <strong>{c.recent.length}</strong> 轮
          <small>由客户端模型的摘要覆盖范围决定</small>
        </p>
      </div>
      <SummaryHistory
        w={w}
